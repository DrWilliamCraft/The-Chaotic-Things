...
public class ChronoCrafterMenu extends AbstractContainerMenu {
    public final ChronoCrafterBlockEntity blockEntity;
    ...
    public ChronoCrafterMenu(int containerId, Inventory inv , BlockEntity entity, ContainerData data){
        super(ModMenuTypes.CHRONO_CRAFTER_MENU.get(), containerId);
        blockEntity = ((ChronoCrafterBlockEntity) entity);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.CHRONO_CRAFTER.get());
    }
